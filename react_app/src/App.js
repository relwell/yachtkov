  ...
  return (
    <div className="App">
      ...
      <div id="thanks">
        ...
        <p>Check out the code on <a href="https://github.com/relwell/yachtkov">GitHub</a>, or read the <a href="http://robertelwell.info/2019/04/15/yachtkov.html">blog post</a> about it.</p>
      </div>
    </div>
  );
}
